  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        //! TITLE
        const AppTextWidget(
            theText: AppTexts.appName, textType: AppTextType.header),
        ...
        Container(
            ...
            decoration: BoxDecoration(
                color: AppColours.containersBackgroundColour.withOpacity(0.4),
                ...
                children: [
                  Align(
                      ...
                      child: CircleAvatar(
                          ...
                          child: CircleAvatar(
                              radius: 50.0,
                              backgroundColor: AppColours.lettersAndIconsColour,
        ...
        //! NOTICE
        const AppTextWidget(
            theText: AppTexts.wrapperNote, textType: AppTextType.boldBody),
